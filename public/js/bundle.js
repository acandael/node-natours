...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWNhbmRhZWwiLCJhIjoiY2s1bnMybDR1MDcxajNuczV3eHNuNDlrNyJ9.9jhoh3m0pW9XlJN0fMAf1g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/acandael/ck5nw57te114d1invv6qvd6cb',
    scrollZoom: false // center: [-118.105528, 34.127088],
    // zoom: 10,
    // interactive: false
